...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Lección 3 -- Aqui el "elsif" seria "else if"
        //sentenciaIf()

        // Lección 4 -- Basicamente SWITCH -CASE (Funpro)
        //sentenciaWhen()

        // Lección 5 -- Los arrays de siempre, me recueda mucho a LPOO
        //arrays()

        // Lección 6 -- Básicamente diccionarios
        //maps()

        // Lección 7 -- nuevops tipos de loops
        //loops()

        // Lección 8 -- manejo de valores nulos
        //nullSafety()
    ...
    */
    ...
    fun nullSafety() {
        ...
        /*
        **** NOTA Comenté esto por que me da error, sin embargo se usa como ejemplo explicativo
        mySafetyString?.let {
            println(it)
        } ?: run {
            println(mySafetyString)
